...
def my_reduce(combiner, seq):
    ...
    # return my_reduce(combiner, seq[1:])
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    return get_name(city_a) if (distance(make_city('city',lat,lon),city_a) < distance(make_city('city',lat,lon),city_b)) else get_name(city_b)
