...
class Person:
    ...
    def ask(self, stuff):
        self.phrase="Would you please " + stuff
        return self.say("Would you please " + stuff)

    def greet(self):
        self.phrase="Hello, my name is " + self.name
    ...
    def use_item(self, item, quantity):
        if item in self.items:
            if self.items[item]>quantity:
                ...
                self.items[item]=0
                return "Oh no, we need more {}!".format(item)
        else:
            return "Oh no, we don't have any {}!".format(item)
